    ...
    try {
      ...
      if (mounted) {
        if (success) {
          ...
          // Obtener el error específico del estado
...
• Contacta soporte si persiste''';
  ...
  Future<void> _createEmergencyUser() async {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (context) => const AlertDialog(
        content: Column(
          ...
          children: [
            CircularProgressIndicator(),
            SizedBox(height: 16),
            Text('Creando usuario de emergencia...'),
            SizedBox(height: 8),
    ...
    try {
      ...
      final adminResponse = await dio.post('${ApiConstants.baseUrl}/auth/register', data: adminData);
      ...
      if (e is DioException) {
        if (e.response?.statusCode == 400) {
          ...
          errorMessage += 'Respuesta: ${e.response?.data}\n';
        }
      } else {
        errorMessage += 'Error técnico: ${e.toString()}\n';
      }
      
      errorMessage += '\n🔧 SOLUCIONES:\n';
      errorMessage += '• Verifica la conexión a internet\n';
      errorMessage += '• Prueba el "Test de Conexión" primero\n';
      errorMessage += '• Si el usuario ya existe, intenta login directamente\n';
      
      _showResult('❌ Error Creación Usuario', errorMessage, Colors.red);
    }
  }
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Text('¿Primera vez?', style: TextStyle(color: Colors.grey)),
                          ),
                          Expanded(
                            child: Container(
                              height: 1,
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          onPressed: _createEmergencyUser,
                          ...
                          child: const Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 8),
                              Text('Crear Cuenta Admin', style: TextStyle(fontSize: 16)),
                            ],
                          ),
                        ),
                      ),
